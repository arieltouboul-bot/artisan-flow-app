...
export function TrialBanner() {
  ...
  return (
    <div className="sticky top-16 z-40 mb-3 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-900 sm:text-sm">
      <span>{tReplace("trialBannerText", language, { days: daysRemaining })}</span>{" "}
      <Link href="/welcome" className="font-semibold underline underline-offset-2">
