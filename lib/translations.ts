...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  dashboardMaterialBudgetBanner: {
    fr: "Un ou plusieurs chantiers dépassent le budget matériaux. Voir Finance.",
    en: "One or more projects exceed the materials budget. See Finance.",
  },
  dashboardMaterialBudgetCta: { fr: "Ouvrir Finance", en: "Open Finance" },
  ...
  revenuePageSubtitle: {
    fr: "Enregistrez les encaissements liés à vos chantiers.",
    en: "Record payments linked to your projects.",
  },
