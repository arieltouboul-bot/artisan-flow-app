...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  revenueModalMarginHint: {
    fr: "Revenus totaux moins coûts chantier (matériaux saisis + dépenses matériel/location).",
    en: "Total revenue minus project costs (materials field + material/rental expense lines).",
  },
  revenueModalTotalEarned: { fr: "Total encaissé (revenus)", en: "Total earned (revenue)" },
  revenueModalTotalExpenses: { fr: "Total charges (matériaux + dépenses)", en: "Total costs (materials + expenses)" },
