...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  architectOllamaWarning: {
    fr: "Veuillez verifier qu'Ollama est lance.",
    en: "Please verify Ollama is running.",
  },
  ...
  architectCategoryGeneral: { fr: "general", en: "general" },
  ...
  architectBadgeStructural: { fr: "Gros oeuvre", en: "Structural" },
  architectBadgeInsulation: { fr: "Isolation", en: "Insulation" },
  architectBadgeFinishing: { fr: "Finition", en: "Finishing" },
  architectBadgeRoofing: { fr: "Toiture", en: "Roofing" },
  architectInventoryTitle: { fr: "Inventaire Materiaux", en: "Materials Inventory" },
  architectInventoryEmpty: { fr: "Aucun materiau utilise.", en: "No materials used yet." },
  architect3dFallback: {
