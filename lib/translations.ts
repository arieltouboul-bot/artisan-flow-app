...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  revenueDescriptionLabel: { fr: "Description (optionnel)", en: "Description (optional)" },
  ...
  revenueSearchPlaceholder: { fr: "Filtrer par projet ou description…", en: "Filter by project or description…" },
