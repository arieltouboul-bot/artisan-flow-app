...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  welcomeAccessSubtitle: {
    fr: "Saisissez votre code d'accès premium ou démarrez un essai gratuit de 7 jours.",
  ...
  welcomeTrialSubtitle: { fr: "Découvrir ArtisanFlow pendant 7 jours", en: "Try ArtisanFlow for 7 days" },
  welcomeTrialButton: { fr: "Démarrer l'essai gratuit 7 jours", en: "Start 7-Day Free Trial" },
  welcomeSupabaseMissing: { fr: "Configuration serveur manquante.", en: "Server configuration is missing." },
  welcomeActivationLookupError: { fr: "Impossible de vérifier le code.", en: "Unable to validate this code." },
  welcomeInvalidCode: { fr: "Code invalide.", en: "Invalid access code." },
  welcomeCodeAlreadyUsed: { fr: "Ce code a déjà été utilisé.", en: "This code has already been used." },
  welcomeCodeExpired: { fr: "Ce code a expiré.", en: "This code has expired." },
  welcomeActivationFailed: { fr: "Activation impossible pour le moment.", en: "Activation is currently unavailable." },
  welcomeActivationCodeUpdateFailed: {
    fr: "Activation partielle: contactez le support.",
    en: "Activation partially completed. Please contact support.",
  },
  ...
  trialBannerText: { fr: "Essai gratuit : {days} jour(s) restant(s).", en: "Free Trial: {days} day(s) remaining." },
  trialBannerActivateLink: { fr: "Activer l'accès complet", en: "Activate Full Access" },
