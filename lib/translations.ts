...
export const translations: Record<string, { fr: string; en: string }> = {
  ...
  welcomeAccessTitle: { fr: "Activate Your Access", en: "Activate Your Access" },
  welcomeAccessSubtitle: {
    fr: "Use an access code or start your 7-day free trial.",
    en: "Enter your premium access code or start a 7-day free trial.",
  },
  welcomePremiumTitle: { fr: "Premium Access", en: "Premium Access" },
  welcomePremiumSubtitle: { fr: "Enter your access code", en: "Enter your access code" },
  welcomeAccessCodePlaceholder: { fr: "Access Code", en: "Access Code" },
  welcomeActivateButton: { fr: "Activate My Account", en: "Activate My Account" },
  welcomeTrialTitle: { fr: "Trial", en: "Trial" },
  welcomeTrialSubtitle: { fr: "Try ArtisanFlow for 7 days", en: "Try ArtisanFlow for 7 days" },
  welcomeTrialButton: { fr: "Start 7-Day Free Trial", en: "Start 7-Day Free Trial" },
  welcomeSupabaseMissing: { fr: "Server configuration is missing.", en: "Server configuration is missing." },
  welcomeInvalidCode: { fr: "Invalid access code.", en: "Invalid access code." },
  welcomeActivationFailed: { fr: "Activation is currently unavailable.", en: "Activation is currently unavailable." },
  welcomeActivationSuccess: { fr: "Account activated. Redirecting...", en: "Account activated. Redirecting..." },
  welcomeTrialStartFailed: { fr: "Unable to start the trial.", en: "Unable to start the trial." },
  welcomeTrialStarted: { fr: "Trial started. Redirecting...", en: "Trial started. Redirecting..." },
  trialBannerText: { fr: "Trial Mode: {days} day(s) left.", en: "Trial Mode: {days} day(s) left." },
  trialBannerActivateLink: { fr: "Enter code to unlock permanent access.", en: "Enter code to unlock permanent access." },
